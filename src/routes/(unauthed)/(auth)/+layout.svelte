...
<main class="min-w-screen min-h-svh flex flex-col text-white">
	<header
		class="header md:p-8 top-4 bg-transparent md:text-white text-amber-600 p-0 fixed w-screen md:relative md:w-full"
	>
		<h1 class="text-4xl font-bold text-center">Salyte</h1>
	</header>
	{#key path}
	...
	{/key}
	<footer
		class="footer md:mb-5 bg-transparent md:text-white bottom-4 text-amber-600 fixed w-screen md:relative md:w-full"
	>
		<p class="text-center">
