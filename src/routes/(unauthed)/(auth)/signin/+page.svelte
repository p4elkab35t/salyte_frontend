...
<div class="felx self-center content-center place-self-center">
    <InputForm formLabel="Sign In" bind:isSubmitting={isSubmitting}>
        ...
        <a href="/signup" class="text-amber-600 hover:text-amber-700 hover:underline p-8 -translate-y-9 lg:-translate-y-7">I am a new user here!</a>
    </InputForm>
</div>